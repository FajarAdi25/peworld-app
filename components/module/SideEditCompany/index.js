...
import { FaMapPin, FaPen, FaPencilAlt } from "react-icons/fa";
const SideEditCompany = () => {
  return (
      ...
      <article className="bg-white rounded-md">
        <div className="px-3 lg:px-10 py-8">
          ...
          <div className="text-sm">
            ...
            <p className="mt-2">HR Specialist</p>
            <p className="mt-2">Pijar Camp</p>
...
export default SideEditCompany;
